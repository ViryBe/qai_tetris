...
\section{Rapport}
Le rapport est rédigé en \LaTeX{}, les figures sont faites grâce a
\texttt{tikz} et les graphes avec \texttt{pgfplot}. Le rapport est compilé via
un \textit{makefile} dédié

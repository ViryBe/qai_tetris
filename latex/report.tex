...
\section{Rapport}
Le rapport est rédigé en \LaTeX{}, les figures sont faites grace a \texttt{tikz}
et les graphes avec \texttt{pgfplot}. Le rapport est compilé via un
\textit{makefile} dédié
automatisant la génération des fichiers de données pour créer les courbes. Le
programme \texttt{latexmk} est également utilise pour faciliter la compilation.

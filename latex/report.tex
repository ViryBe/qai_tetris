...
Pour identifier les plages optimales des paramètres et leur influences, seront
tracés pour chacun d'eux deux faisceaux de courbes. L'un mettra en évidence
l'évolution de l'apprentissage en fonction de variations fortes de ce paramètre
et l'autre se focalisera sur la zone jugée optimale. Les principaux facteurs
discriminants recherchés seront la hauteur finale et la vitesse de convergence.
